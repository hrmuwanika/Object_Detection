...
" style="text-decoration: none;" >Download</a>  </span> <br>
       ...
       <span><b>- Tensorflow 1.14.0 (and later versions)  </b>      <a href="https://www.tensorflow.org/install/install_windows" style="text-decoration: none;" > Install</a></span> or install via pip <pre> pip3 install tensorflow==1.15.0 </pre> 
